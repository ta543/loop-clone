  ...
  return (
    <div className="sticky box-border caret-transparent z-[12] top-0">
      <div
        ...
        role="region"
        className="relative text-white bg-fixed bg-neutral-900 box-border caret-transparent block list-none z-[1] overflow-hidden mx-auto"
      >
        <div className="relative caret-transparent flex h-10 w-full z-[1] items-center justify-center">
          <div
            role="group"
            aria-label="3 / 3"
            className="hidden"
          ...
          >
            <p className="box-border caret-transparent break-words">
              Free shipping over <span className="box-border caret-transparent break-words">39 EUR</span>
            </p>
          </div>
          <div
            role="group"
            aria-label="2 / 3"
            className="relative text-white text-sm font-avanttregular font-normal items-center box-border caret-transparent gap-x-2 flex shrink-0 justify-center tracking-[-0.28px] leading-5 gap-y-2 text-center h-10 w-[901px] p-2"
          >
            <p className="box-border caret-transparent break-words">
