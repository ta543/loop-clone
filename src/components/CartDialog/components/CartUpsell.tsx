...
} from "@/components/CartDialog/components/UpsellProduct";

const UPSELL_PRODUCTS: UpsellProductProps[] = [
  {
    productName: "Loop Switch 2",
    productUrl: "https://www.loopearplugs.com/products/switch",
    mainImageUrl:
      "https://www.loopearplugs.com/cdn/shop/files/PDP_SWITCH_EMERALD_1-371454.png?v=1729670651&width=180",
  ...
  },
  {
    ...
    mainImageUrl:
      "https://www.loopearplugs.com/cdn/shop/files/PDP_DREAM_BLACK_1-917582.png?v=1756884316&width=180",
    mainImageAlt: "Black",
...
export const CartUpsell = () => {
  ...
  const maxIndex = UPSELL_PRODUCTS.length - 1;
  ...
  return (
    <div className="bg-[#ececec]">
      <div className="flex items-center justify-between px-4 pb-4 pt-5">
        ...
        <div className="flex items-center gap-2 text-neutral-800">
          <button
            ...
            className="inline-flex h-6 w-6 items-center justify-center rounded-full text-neutral-400 disabled:cursor-not-allowed disabled:opacity-40"
          >
          ...
          <button
            ...
            className="inline-flex h-6 w-6 items-center justify-center rounded-full disabled:cursor-not-allowed disabled:opacity-40"
          >
      ...
      <div className="overflow-hidden px-4">
        <ul role="list" aria-label="You may also like" className="pb-5">
          <UpsellProduct {...UPSELL_PRODUCTS[currentIndex]} />
        </ul>
      </div>
      <div className="px-4 pb-5">
        <div className="h-1 rounded-full bg-[#cecece]">
          <div
            className="h-full rounded-full bg-[#23242a] transition-all duration-300"
